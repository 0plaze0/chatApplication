...
//The buttonProps inherits the property of ButtonHtmlAttibutes() and variantProps specifictype which is buttonVariants
//ButtonHTMLAttributes is a utility types that modifies the HTMLbuttonElement interface and we can also pass our own HTMLButtonElement. similarly variantProps also
